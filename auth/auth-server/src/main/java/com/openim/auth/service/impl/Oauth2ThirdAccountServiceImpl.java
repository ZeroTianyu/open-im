...
import com.openim.auth.mapper.Oauth2ThirdAccountMapper;
import com.openim.auth.service.IOauth2BasicUserService;
import com.openim.auth.service.IOauth2ThirdAccountService;
...
public class Oauth2ThirdAccountServiceImpl extends ServiceImpl<Oauth2ThirdAccountMapper, Oauth2ThirdAccount> implements IOauth2ThirdAccountService {
    ...
    public void checkAndSaveUser(Oauth2ThirdAccount thirdAccount) {
        ...
        if (oauth2ThirdAccount == null) {
            // 生成用户信息
            Long userId = basicUserService.saveByThirdAccount(thirdAccount);
